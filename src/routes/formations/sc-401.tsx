...
export const Route = createFileRoute('/formations/sc-401')({
  component: FormationPage,
  head: () => ({
    meta: [
      { title: "SC-401 Information Security Administrator | GALACTUS Digital" },
      { name: "description", content: "Formation SC-401 Purview protection info IA. 28h. Certification. Voucher inclus. Qualiopi." },
    ],
  }),
})
...
const DATA = {
  ...
  titre: 'Information Security Administrator',
  sousTitre: 'Certification Information Security Administrator — SC-401',
  ref: 'SC-401-001',
  ...
  examen: { code: 'SC-401', duree: '120 minutes', langue: 'Français / Anglais', organisme: 'Microsoft (Pearson VUE)', format: 'QCM, études de cas et scénarios', score: '700 / 1000', note: `Certification Information Security Administrator (remplace SC-400), valable 12 mois, renouvelable via Microsoft Learn. Le passage de l examen (voucher officiel) est inclus dans le tarif de la formation.` },
...
function FormationPage() {
  const FORMATION = getFormationBySlug('sc-401')
          ...
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
              {[
                ...
                { icon: <Calendar size={14} />, text: 'Voir calendrier', href: '/calendrier?f=sc-401' },
              ].map((m, i) => (
                m.href ? (
