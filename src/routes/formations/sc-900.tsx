...
const DATA = {
  ...
  methodes: [
    ...
    "Certification Microsoft Certified: Security, Compliance, and Identity Fundamentals (SC-900) envoyée par mail à l'issue du parcours",
...
function FormationPage() {
  const FORMATION = getFormationBySlug('sc-900')
          ...
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
              {[
                ...
                { icon: <Calendar size={14} />, text: 'Voir calendrier', href: '/calendrier?f=sc-900' },
              ].map((m, i) => (
                m.href ? (
