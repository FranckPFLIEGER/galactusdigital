...
const DATA = {
  ...
  examen: { code: '200-301 CCNA', duree: '120 minutes', langue: 'Anglais', organisme: 'Pearson VUE', format: 'QCM, drag-and-drop, simulation réseau Cisco', score: '825 / 1000', note: 'Ce module est le 3ème et dernier requis. La certification CCNA 200-301 est obtenue après validation des 3 modules ITN + SRWE + ENSA et passage de l\'examen Pearson VUE.' },
      ...
      <main style={{ paddingTop: '72px' }}>
        ...
        <section style={{ background: 'var(--g-black)', padding: '3rem 2rem', borderTop: '4px solid var(--g-red)' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '2rem', flexWrap: 'wrap' }}>
            <div><h2 className="section-h2-light" style={{ marginBottom: '0.4rem' }}>S'inscrire à cette formation</h2><p style={{ fontSize: '0.90rem', color: 'rgba(255,255,255,0.55)', margin: 0 }}>Contactez-nous pour les prochaines dates et un devis sous 48h.</p></div>
