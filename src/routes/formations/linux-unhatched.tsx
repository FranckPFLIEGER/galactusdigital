...
export const Route = createFileRoute('/formations/linux-unhatched')({
  component: LinuxUnhatchedPage,
  head: () => ({
    meta: [
      { title: "Linux Unhatched — Formation Linux sans prérequis | GALACTUS Digital" },
      { name: "description", content: "Formation Linux Unhatched. 8h, aucun prérequis. Installation, ligne de commande, premiers pas Linux. Porte d'entrée vers Linux Essentials et LPIC-1. Qualiopi." },
    ],
  }),
})
...
const DATA = {
  ...
  sousTitre:      'Bloc 0 · Première approche de Linux, porte d\'entrée vers le LPIC-1',
  ref:            'SOCLE-LUH-007',
  ...
  // Description
  description: 'Linux fait tourner l\'essentiel des serveurs et des infrastructures cloud. Ce cours court, explicitement conçu pour les personnes en reconversion professionnelle, donne les premiers repères : installation, configuration de base et surtout ligne de commande. 22 sections d\'exercices pratiques qui posent les fondations pour Linux Essentials, puis les certifications LPI. Aucun prérequis.',

  // Objectifs pédagogiques
  objectifs: [
    'Expliquer ce qu\'est Linux, son histoire et ses domaines d\'usage',
    'Se repérer dans l\'arborescence d\'un système de fichiers Linux',
    'Utiliser les commandes essentielles du terminal (navigation, fichiers, aide)',
    'Installer et configurer une distribution Linux simple',
    'Lire et interpréter la sortie d\'une commande',
    'Identifier les métiers et certifications accessibles via Linux',
  ],
  ...
  modules: [
    {
      num: '01–06', titre: 'Découvrir Linux', duree: '2h',
      contenu: [
        'Origines, philosophie et écosystème des distributions',
        'Où Linux est utilisé : serveurs, cloud, embarqué, réseau',
        'Installation et premier démarrage',
      ],
    },
    {
      num: '07–13', titre: 'Le terminal et le système de fichiers', duree: '3h',
      contenu: [
        'Ouvrir un terminal et comprendre l\'invite de commande',
        'Arborescence : /, /home, /etc, /var et leurs rôles',
        'Navigation : cd, ls, pwd',
        'Exercices interactifs guidés',
      ],
    },
    {
      num: '14–19', titre: 'Manipuler fichiers et répertoires', duree: '2h',
      contenu: [
        'Créer, copier, déplacer et supprimer (touch, mkdir, cp, mv, rm)',
    ...
    {
      num: '20–22', titre: 'Aller plus loin', duree: '1h',
      contenu: [
        'Utilisateurs, droits et notions d\'administration',
        'Parcours de certification Linux : LPI Linux Essentials puis LPIC-1',
  ...
  // Examen
  examen: {
    code:       'Badge NetAcad — Linux Unhatched',
    duree:      'Examen final intégré au cours',
    langue:     'Français',
    organisme:  'Cisco Networking Academy (en collaboration avec NDG)',
    format:     '22 sections, exercices interactifs et examen final',
    score:      'Selon barème NetAcad',
    note: 'Ce cours n\'est pas aligné sur une certification, il en prépare l\'accès. Cours suivant recommandé : Linux Essentials (LPI 010-160), puis NDG Linux I et II vers le LPIC-1.',
  },
...
function LinuxUnhatchedPage() {
  const FORMATION = getFormationBySlug('linux-unhatched')
          ...
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
              {[
                ...
                { icon: <Calendar size={14} />, text: 'Voir calendrier', href: '/calendrier?f=linux-unhatched' },
              ].map((m, i) => (
                m.href ? (
