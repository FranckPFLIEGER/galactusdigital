...
export const Route = createFileRoute('/formations/ms-102')({
  component: FormationPage,
  head: () => ({
    meta: [
      { title: "MS-102 Microsoft 365 Administrator | GALACTUS Digital" },
      { name: "description", content: "Formation MS-102 M365 Administrator. 35h. Certification. Voucher inclus. Qualiopi." },
    ],
  }),
})
...
const DATA = {
  ...
  titre: 'Microsoft 365 Administrator',
  sousTitre: 'Certification Microsoft 365 Administrator — MS-102',
  ref: 'MS-102-001',
  ...
  examen: { code: 'MS-102', duree: '120 minutes', langue: 'Français / Anglais', organisme: 'Microsoft (Pearson VUE)', format: 'QCM, études de cas et scénarios', score: '700 / 1000', note: `Certification Microsoft 365 Administrator Expert, valable 12 mois, renouvelable via Microsoft Learn. Le passage de l examen (voucher officiel) est inclus dans le tarif de la formation.` },
...
function FormationPage() {
  const FORMATION = getFormationBySlug('ms-102')
          ...
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
              {[
                ...
                { icon: <Calendar size={14} />, text: 'Voir calendrier', href: '/calendrier?f=ms-102' },
              ].map((m, i) => (
                m.href ? (
