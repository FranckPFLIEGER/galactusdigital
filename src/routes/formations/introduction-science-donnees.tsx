...
export const Route = createFileRoute('/formations/introduction-science-donnees')({
  component: IntroductionScienceDonneesPage,
  head: () => ({
    meta: [
      { title: "Introduction à la science des données — Formation sans prérequis | GALACTUS Digital" },
      { name: "description", content: "Formation Introduction à la science des données. 6h, aucun prérequis. Donnée, analyse, machine learning, métiers de la data. Reconversion. Qualiopi." },
    ],
  }),
})
...
const DATA = {
  ...
  // Description
  description: 'Avant Power BI et le DAX, il faut savoir ce qu\'est une donnée et ce qu\'on peut lui faire dire. Ce cours pose les bases de la science des données, de l\'analyse et de l\'ingénierie de la donnée, et montre comment le machine learning transforme déjà les entreprises, la santé et l\'enseignement. Il ouvre le panorama des métiers de la data. Aucun prérequis, aucun niveau en mathématiques exigé.',

  // Objectifs pédagogiques
  objectifs: [
    'Distinguer donnée, information, analyse et machine learning',
    'Décrire le cycle de vie d\'une donnée, de la collecte à la décision',
    'Lire et construire un tableau croisé dynamique',
    'Identifier les usages du machine learning dans différents secteurs',
    'Reconnaître une visualisation de données trompeuse',
    'Situer les métiers de la data, de l\'analytique et de l\'IA et leurs débouchés',
  ],
  ...
  modules: [
    {
      num: '01', titre: 'Qu\'est-ce que la science des données', duree: '1h30',
      contenu: [
        'Donnée, information, connaissance : les distinguer',
        'Science des données, analytique et ingénierie des données',
        'Exemples concrets par secteur d\'activité',
      ],
    },
    {
      num: '02', titre: 'Le cycle de vie de la donnée', duree: '1h30',
      contenu: [
        'Collecte, nettoyage, stockage et analyse',
        'Qualité des données et biais courants',
        'TP — Nettoyage d\'un jeu de données simple',
      ],
    },
    {
      num: '03', titre: 'Analyser et visualiser', duree: '2h',
      contenu: [
        'Widget de tableau croisé dynamique interactif',
        'Choisir la bonne visualisation selon la question posée',
        'Reconnaître un graphique trompeur',
        'TP — Construction d\'un tableau de bord simple',
      ],
    },
    {
      num: '04', titre: 'Machine learning et métiers de la data', duree: '1h',
      contenu: [
        'Comment une machine apprend à partir de données',
        'Data analyst, data engineer, data scientist : qui fait quoi',
  ...
  // Examen
  examen: {
    code:       'Badge NetAcad — Introduction to Data Science',
    duree:      'Examen final intégré au cours',
    langue:     'Français',
    organisme:  'Cisco Networking Academy',
    format:     '4 modules, 5 travaux pratiques, quiz et examen final',
    score:      'Selon barème NetAcad',
    note: 'Cours suivant recommandé : Data Analytics Essentials (30 h), puis PL-300 Power BI Data Analyst. Ce cours ouvre le Bloc 0 du parcours Data, IA & Copilot Microsoft.',
  },
...
function IntroductionScienceDonneesPage() {
  const FORMATION = getFormationBySlug('introduction-science-donnees')
          ...
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
              {[
                ...
                { icon: <Calendar size={14} />, text: 'Voir calendrier', href: '/calendrier?f=introduction-science-donnees' },
              ].map((m, i) => (
                m.href ? (
