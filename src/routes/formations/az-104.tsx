...
export const Route = createFileRoute('/formations/az-104')({
  component: FormationPage,
  head: () => ({
    meta: [
      { title: "AZ-104 Azure Administrator Microsoft — Formation certifiante | GALACTUS Digital" },
      { name: "description", content: "Formation Microsoft AZ-104 Azure Administrator. 40h. Certification officielle. Gestion Azure réseaux virtuels stockage. Qualiopi." },
    ],
  }),
})
...
const DATA = {
  ...
  titre: 'Azure Administrator',
  sousTitre: 'Certification Microsoft Azure Administrator Associate · Référence : AZ-104',
  ref: 'AZ-104-001',
  ...
  description: `Formation avancée pour les administrateurs Azure en charge du déploiement, de la gestion et de la supervision des environnements cloud Microsoft. Elle couvre la gestion des identités Entra ID, le stockage, le compute, les réseaux virtuels et la supervision. Renouvellement annuel gratuit via Microsoft Learn.`,
  objectifs: ["Gérer les identités Azure avec Microsoft Entra ID — RBAC, groupes, MFA, accès conditionnel", "Configurer et gérer le stockage Azure — Blob, Files, Tables, Queues, Data Lake", "Déployer et gérer les machines virtuelles Azure — Scale Sets, disponibilité, images", "Configurer les réseaux virtuels Azure — VNet, NSG, peering, VPN Gateway, ExpressRoute", "Superviser et sauvegarder les ressources — Azure Monitor, Log Analytics, Backup, Site Recovery", "Gérer les abonnements et la gouvernance — Policy, Cost Management, Blueprints, Tags"],
  public: ["Administrateurs systèmes migrant vers Azure", "Ingénieurs infrastructure cloud", "Certifiés AZ-900 souhaitant progresser", "Architectes solutions Azure débutants"],
  prerequis: ["Expérience de l'administration Windows Server ou Linux", "Connaissance des réseaux TCP/IP, DNS, Active Directory", "AZ-900 recommandé mais non obligatoire", "Expérience pratique avec le portail Azure"],
  examen: {
    code: 'AZ-104',
    duree: '120 minutes',
    ...
    score: '700 / 1000',
    note: `La certification AZ-104 est valable 12 mois. Renouvellement gratuit via une évaluation en ligne sur Microsoft Learn. Le passage de l'examen (voucher officiel) est inclus dans le tarif de la formation.`,
  },
  methodes: [
    ...
    "Certification Microsoft Certified: Azure Administrator Associate (AZ-104) envoyée par mail à l'issue du parcours",
...
function FormationPage() {
  const FORMATION = getFormationBySlug('az-104')
          ...
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
              {[
                ...
                { icon: <Calendar size={14} />, text: 'Voir calendrier', href: '/calendrier?f=az-104' },
              ].map((m, i) => (
                m.href ? (
