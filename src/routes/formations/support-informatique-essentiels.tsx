...
export const Route = createFileRoute('/formations/support-informatique-essentiels')({
  component: SupportInformatiqueEssentielsPage,
  head: () => ({
    meta: [
      { title: "Essentiels du support informatique — Certification CCST IT Support | GALACTUS Digital" },
      { name: "description", content: "Formation Essentiels du support informatique. 56h, aucun prérequis. Préparation certification Cisco CCST IT Support 100-140. 103 laboratoires. Reconversion. Qualiopi." },
    ],
  }),
})
...
const DATA = {
  ...
  sousTitre:      'Préparation à la certification Cisco CCST IT Support (100-140)',
  ref:            'SOCLE-CCST-010',
  niveau:         'Fondamental',
  ...
  // Description
  description: 'La formation d\'entrée dans l\'emploi la plus directe du catalogue. Sans aucun prérequis, elle amène à une certification Cisco reconnue par les employeurs et à un poste de support de niveau 1. Le programme couvre le matériel, les systèmes Windows et macOS, le dépannage réseau, la gestion de la file d\'incidents et les menaces de sécurité courantes. 103 laboratoires pratiques et 82 vidéos.',

  // Objectifs pédagogiques
  objectifs: [
    'Assurer les tâches quotidiennes d\'un poste de support : file d\'incidents, priorisation, documentation',
    'Construire, dépanner et gérer des postes de travail et leurs périphériques',
    'Installer, configurer et dépanner Windows et macOS',
    'Diagnostiquer et résoudre les problèmes de connectivité réseau les plus fréquents',
    'Identifier les menaces de sécurité courantes et appliquer les mesures de protection de base',
    'Communiquer efficacement avec un utilisateur non technique lors d\'une intervention',
  ],
  ...
  modules: [
    {
      num: '01–02', titre: 'Le métier du support informatique', duree: '8h',
      contenu: [
        'Rôle du technicien support et attentes des employeurs',
        'Gestion de la file d\'incidents, priorisation et gestion du temps',
        'Documentation des interventions et escalade',
        'Communication avec un utilisateur non technique',
      ],
    },
    {
      num: '03–04', titre: 'Matériel et périphériques', duree: '12h',
      contenu: [
        'Composants d\'un poste de travail et de ses périphériques',
        'Assemblage, remplacement et mise à niveau',
        'Imprimantes, écrans et postes mobiles',
        'TP — Diagnostic et réparation de pannes matérielles',
      ],
    },
    {
      num: '05–06', titre: 'Systèmes d\'exploitation Windows et macOS', duree: '14h',
      contenu: [
        'Installation, configuration et mise à jour',
        'Comptes, droits, profils et stratégies locales',
        'Outils d\'administration et de diagnostic',
        'TP — Restauration d\'un poste défaillant',
      ],
    },
    {
      num: '07–08', titre: 'Connectivité et dépannage réseau', duree: '12h',
      contenu: [
        'Adressage IP, DHCP, DNS et passerelle par défaut',
        'Wi-Fi, câblage et équipements d\'accès',
        'Méthodologie de dépannage réseau structurée',
        'TP — Résolution d\'incidents de connectivité',
      ],
    },
    {
      num: '09–10', titre: 'Sécurité et préparation à l\'examen', duree: '10h',
      contenu: [
        'Menaces courantes : logiciels malveillants, hameçonnage, accès non autorisés',
        'Mesures de protection sur un poste utilisateur',
        'Révision par domaine d\'examen CCST IT Support',
        'Examens blancs en conditions réelles + examen final du cours',
      ],
    },
  ],
  ...
  // Examen
  examen: {
    code:       '100-140 CCST IT Support',
    duree:      '50 minutes',
    langue:     'Anglais',
    organisme:  'Certiport / Pearson VUE',
    format:     'QCM, réponses multiples et questions interactives',
    score:      'Résultat en réussite / échec (pas de score publié)',
    note: 'Certification valable 5 ans, assortie d\'un badge Credly. Cisco recommande environ 150 heures d\'instruction et de pratique au total pour l\'ensemble du programme CCST. Cours suivant recommandé : Networking Essentials, puis le cursus CCNA. Prévoir l\'inscription à l\'examen auprès d\'un centre Certiport ou en surveillance à distance.',
  },
...
function SupportInformatiqueEssentielsPage() {
  const FORMATION = getFormationBySlug('support-informatique-essentiels')
          ...
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
              {[
                ...
                { icon: <Calendar size={14} />, text: 'Voir calendrier', href: '/calendrier?f=support-informatique-essentiels' },
              ].map((m, i) => (
                m.href ? (
