          ...
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            ...
            <div id="cgv" className="legal-section" style={{ marginTop: '3rem' }}>
              ...
              {[
                ...
                { num: '16', title: 'Protection des données personnelles', content: `Conformément à la loi n° 78-17 du 6 janvier 1978 et au RGPD, le stagiaire dispose d'un droit d'accès, de modification et de rectification de ses données personnelles. Contact : president@galactusdigital.com ou 66 avenue des Champs Élysées, 75008 Paris. Les données sont conservées pour la durée nécessaire à l'appréciation de la formation.` },
                { num: '17', title: 'Droit applicable et juridiction', content: `Les présentes CGV sont régies par le droit français. En cas de litige, une solution amiable sera recherchée en priorité. À défaut, les Tribunaux de Paris sont seuls compétents.` },
                { num: '18', title: 'Sollicitation des appréciations', content: `En fin de formation, les appréciations des apprenants et de leur hiérarchie sont recueillies le dernier jour. Une relance est effectuée 15 jours après. Une sollicitation à froid est envoyée 2 mois après la formation pour mesurer l'impact sur le poste de travail, avec relance tous les 15 jours en cas de non-retour.` },
              ].map(article => (
