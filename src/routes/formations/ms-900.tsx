...
export const Route = createFileRoute('/formations/ms-900')({
...
function FormationPage() {
  const FORMATION = getFormationBySlug('ms-900')
          ...
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
              {[
                ...
                { icon: <Calendar size={14} />, text: 'Voir calendrier', href: '/calendrier?f=ms-900' },
              ].map((m, i) => (
                m.href ? (
