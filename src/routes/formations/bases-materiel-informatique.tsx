...
export const Route = createFileRoute('/formations/bases-materiel-informatique')({
  component: BasesMaterielInformatiquePage,
  head: () => ({
    meta: [
      { title: "Les bases du matériel informatique — Formation sans prérequis | GALACTUS Digital" },
      { name: "description", content: "Formation Les bases du matériel informatique. 6h, aucun prérequis. Composants PC, portables, terminaux mobiles. Brique CCST Cybersecurity. Reconversion. Qualiopi." },
    ],
  }),
})
...
const DATA = {
  ...
  // Description
  description: 'Ouvrir un ordinateur, reconnaître ses composants, en remplacer un. Ce cours couvre les concepts et les gestes nécessaires pour assembler, réparer ou faire évoluer un poste fixe, un portable ou un terminal mobile. C\'est la base concrète du métier de technicien, et la première compétence que vérifie un employeur sur un poste de support. Aucun prérequis.',

  // Objectifs pédagogiques
  objectifs: [
    'Identifier les composants d\'un ordinateur de bureau et expliquer leur rôle',
    'Installer les composants nécessaires pour assembler, réparer ou mettre à niveau un PC',
    'Expliquer les caractéristiques et les fonctions spécifiques des ordinateurs portables',
    'Expliquer les caractéristiques et les fonctions des tablettes et téléphones mobiles',
    'Choisir un composant compatible à partir d\'une configuration existante',
    'Appliquer les règles de sécurité électrique et antistatique lors d\'une intervention',
  ],
  ...
  modules: [
    {
      num: '01', titre: 'Composants d\'un ordinateur de bureau', duree: '2h',
      contenu: [
        'Carte mère, processeur, mémoire vive, stockage, alimentation',
        'Cartes d\'extension, refroidissement et boîtier',
        'Sécurité électrique et précautions antistatiques',
        'TP — Identification des composants et démontage guidé',
      ],
    },
    {
      num: '02', titre: 'Assemblage, réparation et mise à niveau', duree: '2h',
      contenu: [
        'Monter un PC composant par composant',
        'Diagnostiquer une panne matérielle simple',
        'Choisir un composant compatible pour une mise à niveau',
        'TP — Assemblage complet et test de démarrage',
      ],
    },
    {
      num: '03', titre: 'Portables et terminaux mobiles', duree: '2h',
      contenu: [
        'Spécificités des ordinateurs portables : batterie, écran, clavier, dissipation',
        'Tablettes et téléphones : architecture et composants',
        'Interventions possibles et limites sur un matériel mobile',
  ...
  // Examen
  examen: {
    code:       'Badge NetAcad — Computer Hardware Basics',
    duree:      'Examen final intégré au cours',
    langue:     'Français',
    organisme:  'Cisco Networking Academy',
    format:     'Exercices, travaux pratiques et examen final',
    score:      'Selon barème NetAcad',
    note: 'Ce cours fait partie du parcours de carrière Analyste junior en cybersécurité et s\'aligne sur la certification CCST Cybersecurity. Cours suivant recommandé : Operating System Basics, puis Notions de base sur les réseaux.',
  },
...
function BasesMaterielInformatiquePage() {
  const FORMATION = getFormationBySlug('bases-materiel-informatique')
          ...
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
              {[
                ...
                { icon: <Calendar size={14} />, text: 'Voir calendrier', href: '/calendrier?f=bases-materiel-informatique' },
              ].map((m, i) => (
                m.href ? (
