...
// ─── Couleurs par famille — déclinaison 100% chartée (rouge / noir / gris) ─────
...
// Niveaux — nuances chartées : gris (fondamental) → rouge atténué → rouge plein
    ...
    <header className={`site-nav${(scrolled || isInternal) ? ' scrolled' : ''}`}>
      ...
      <div className="nav-ticker">
        <div className="nav-ticker-inner">
          <span>Prochaine formation en présentielle à la Martinique : MICROSOFT MD-102 Endpoint Administrator du 25/01/27 au 29/01/27</span>
        </div>
      </div>
