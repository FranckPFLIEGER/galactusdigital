...
export const Route = createFileRoute('/formations/ms-900')({
  ...
  head: () => ({
    meta: [
      { title: "MS-900 Microsoft 365 Fundamentals — Formation certifiante | GALACTUS Digital" },
      { name: "description", content: "Formation Microsoft MS-900 Microsoft 365 Fundamentals. 18h. Certification officielle. Teams SharePoint sécurité M365. Qualiopi." },
    ],
  }),
})
...
const DATA = {
  ...
  titre: 'Microsoft 365 Fundamentals',
  sousTitre: 'Certification Microsoft 365 Fundamentals · Référence : MS-900',
  ref: 'MS-900-001',
  niveau: 'Fondamental',
  partenaire: 'Partenaire Microsoft n° 4653557',
  certification: 'Microsoft Certified: Microsoft 365 Fundamentals (MS-900)',
  duree: '18 heures',
  groupeMin: 4,
  groupeMax: 12,
  lieux: ['Martinique', 'Guadeloupe', 'Paris', 'FOAD'],
  description: `Formation d'introduction à l'écosystème Microsoft 365 — cloud, productivité, sécurité et conformité. Elle couvre Teams, SharePoint, Exchange Online, la mobilité d'entreprise avec Intune et les concepts de sécurité M365. Idéale pour les professionnels non-techniques et les administrateurs IT débutant avec M365. La certification MS-900 n'expire pas.`,
  objectifs: ["Décrire les concepts cloud de Microsoft 365 — abonnements, modèles de déploiement hybrides", "Décrire les solutions de productivité M365 — Teams, Exchange Online, SharePoint, OneDrive", "Décrire les solutions collaboratives — Microsoft Viva, Power Platform, Yammer", "Décrire la sécurité et conformité M365 — Purview, Defender for M365, DLP, Archivage", "Décrire la gestion des appareils avec Microsoft Intune et Windows Autopilot", "Comprendre la tarification et les licences Microsoft 365 (E1, E3, E5, Business plans)"],
