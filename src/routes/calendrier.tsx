...
import { MapPin, Phone, Mail, Clock, Users, Info, Euro, Search, X, ChevronDown, Filter } from 'lucide-react'
...
const RAW: (Session | null)[] = [
  // Réseaux & CCNA
  s('networking-essentials','Martinique','Présentiel'),
  s('networking-essentials','Guadeloupe','Présentiel'),
  s('networking-essentials','Tous territoires','FOAD'),
  s('networking-essentials','Tous territoires','E-learning'),
  s('ccna-itn','Martinique','Présentiel'),
  s('ccna-itn','Guadeloupe','Présentiel'),
  s('ccna-itn','Paris','Présentiel'),
  s('ccna-itn','Tous territoires','FOAD'),
  s('ccna-itn','Tous territoires','E-learning'),
  s('ccna-srwe','Martinique','Présentiel'),
  s('ccna-srwe','Tous territoires','FOAD'),
  s('ccna-srwe','Tous territoires','E-learning'),
  s('ccna-ensa','Martinique','Présentiel'),
  s('ccna-ensa','Tous territoires','FOAD'),
  s('ccna-ensa','Tous territoires','E-learning'),
  // Cybersécurité
  s('cybersecurity-essentials','Martinique','Présentiel'),
  s('cybersecurity-essentials','Tous territoires','FOAD'),
  s('cybersecurity-essentials','Tous territoires','E-learning'),
  s('cyberops','Martinique','Présentiel'),
  s('cyberops','Guadeloupe','Présentiel'),
  s('cyberops','Tous territoires','FOAD'),
  s('cyberops','Tous territoires','E-learning'),
  s('ethical-hacker','Martinique','Présentiel'),
  s('ethical-hacker','Tous territoires','FOAD'),
  // Programmation
  s('python-essentials-1','Martinique','Présentiel'),
  s('python-essentials-1','Tous territoires','FOAD'),
  s('python-essentials-1','Tous territoires','E-learning'),
  s('python-essentials-2','Martinique','Présentiel'),
  s('python-essentials-2','Tous territoires','FOAD'),
  s('python-essentials-2','Tous territoires','E-learning'),
  s('devnet-associate','Martinique','Présentiel'),
  s('devnet-associate','Tous territoires','FOAD'),
  // IoT
  s('iot-introduction','Martinique','Présentiel'),
  s('iot-introduction','Tous territoires','FOAD'),
  s('iot-introduction','Tous territoires','E-learning'),
  s('iot-connecting-things','Martinique','Présentiel'),
  s('iot-connecting-things','Tous territoires','FOAD'),
  s('iot-big-data-analytics','Martinique','Présentiel'),
  s('iot-big-data-analytics','Tous territoires','FOAD'),
  s('iot-security','Martinique','Présentiel'),
  s('iot-security','Tous territoires','FOAD'),
  s('iot-hackathon','Martinique','Présentiel'),
  s('iot-hackathon','Tous territoires','FOAD'),
  // Linux & Data
  s('linux-essentials','Martinique','Présentiel'),
  s('linux-essentials','Tous territoires','FOAD'),
  s('linux-essentials','Tous territoires','E-learning'),
  s('data-analytics-essentials','Martinique','Présentiel'),
  s('data-analytics-essentials','Tous territoires','FOAD'),
  s('data-analytics-essentials','Tous territoires','E-learning'),
  // Microsoft
  s('az-900','Martinique','Présentiel'),
  s('az-900','Guadeloupe','Présentiel'),
  s('az-900','Paris','Présentiel'),
  s('az-900','Tous territoires','FOAD'),
  s('az-900','Tous territoires','E-learning'),
  s('az-104','Martinique','Présentiel'),
  s('az-104','Paris','Présentiel'),
  s('az-104','Tous territoires','FOAD'),
  s('az-104','Tous territoires','E-learning'),
  s('sc-900','Martinique','Présentiel'),
  s('sc-900','Tous territoires','FOAD'),
  s('sc-900','Tous territoires','E-learning'),
  s('ai-900','Paris','Présentiel'),
  s('ai-900','Tous territoires','FOAD'),
  s('ai-900','Tous territoires','E-learning'),
  s('ms-900','Martinique','Présentiel'),
  s('ms-900','Tous territoires','FOAD'),
  s('ms-900','Tous territoires','E-learning'),
]
...
function Pill({ label, actif, onClick }: { label: string; actif: boolean; onClick: () => void }) {
  return (
    <button onClick={onClick}
      ...
      onMouseEnter={e => { if (!actif) { e.currentTarget.style.borderColor = 'var(--g-red)'; e.currentTarget.style.color = 'var(--g-red)' }}}
      onMouseLeave={e => { if (!actif) { e.currentTarget.style.borderColor = 'rgba(187,187,187,0.4)'; e.currentTarget.style.color = '#666' }}}>
      {label}
    </button>
  )
}
...
function SessionRow({ s }: { s: Session }) {
  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '3fr 2fr 1.4fr auto', gap: '1.25rem', alignItems: 'center', border: '1px solid rgba(187,187,187,0.28)', borderLeft: `3px solid ${nc}`, padding: '1.2rem 1.75rem', background: 'var(--g-white)', transition: 'box-shadow 0.15s' }}
      ...
      <div>
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.45rem', marginBottom: '0.3rem', flexWrap: 'wrap' }}>
          ...
          <span style={{ display: 'inline-flex', alignItems: 'center', fontFamily: 'var(--font-title)', fontSize: '0.58rem', fontWeight: 700, letterSpacing: '0.10em', textTransform: 'uppercase', color: mc.color, background: mc.bg, padding: '0.12rem 0.5rem' }}>
            {s.modalite}
          </span>
        </div>
        ...
        <div style={{ fontSize: '0.75rem', color: '#888', lineHeight: 1.35 }}>
          ...
          {s.formation.examCode !== 'Badge NetAcad' ? ` · ${s.formation.examCode}` : ''}
        </div>
      </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.35rem' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', fontSize: '0.78rem' }}>
          ...
          {s.prix !== null ? (
            ...
            <span style={{ color: '#aaa', fontStyle: 'italic' }}>Sur demande</span>
          )}
        </div>
        <div style={{ fontSize: '0.70rem', color: '#bbb', fontStyle: 'italic' }}>
          {s.dateLabel}
        </div>
      </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.45rem', alignItems: 'flex-end' }}>
        <a href={`mailto:president@galactusdigital.com?subject=Inscription — ${s.formation.titre} — ${s.territoire} — ${s.modalite}`}
          className="btn-red" style={{ fontSize: '0.68rem', padding: '0.5rem 1rem', whiteSpace: 'nowrap' }}>
          S'inscrire
        </a>
        <a href={`/formations/${s.formation.slug}`}
          style={{ fontSize: '0.66rem', color: 'rgba(187,187,187,0.8)', textDecoration: 'none', textAlign: 'center', transition: 'color 0.15s', whiteSpace: 'nowrap' }}
          onMouseEnter={e => (e.currentTarget.style.color = 'var(--g-red)')}
...
function CalendrierPage() {
  ...
  const results = useMemo(() => SESSIONS.filter(s => {
    ...
    if (query.trim()) {
      ...
      const hay = `${s.formation.titre} ${s.formation.famille} ${s.formation.editeur} ${s.formation.certification} ${s.formation.examCode}`.toLowerCase()
      if (!hay.includes(q)) return false
    }
    return true
  }), [fModalite, fTerritoire, fEditeur, fFamille, fFormation, query])
      ...
      <main style={{ paddingTop: '72px' }}>
          ...
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: '2.5rem', flexWrap: 'wrap' }}>
              {[
                ...
                { val: ['Martinique','Guadeloupe','Paris'].filter(t => SESSIONS.some(x => x.territoire === t)).length.toString(), label: 'Territoires' },
              ].map(st => (
                <div key={st.label}>
          ...
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.75rem', background: 'var(--g-white)', border: '1px solid rgba(187,187,187,0.4)', borderLeft: '4px solid var(--g-red)', padding: '0.85rem 1.25rem' }}>
              ...
              <p style={{ fontSize: '0.81rem', color: '#5a5a58', margin: 0, lineHeight: 1.65 }}>
                ...
                Prix HT — exonéré de TVA (Art. 261-4-4° CGI, organisme certifié Qualiopi NDA 11 75 59933 75).
              </p>
            </div>
          </div>
        </section>
        ...
        <section style={{ background: 'var(--g-white)', padding: '3rem 2rem' }}>
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            ...
            <div style={{ background: 'var(--g-offwhite)', border: '1px solid rgba(187,187,187,0.28)', padding: '1.5rem', marginBottom: '2rem' }}>
              ...
              <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '1rem' }}>
                <div style={{ flex: 1, position: 'relative' }}>
                  ...
                  <input type="text" placeholder="Rechercher une formation (CCNA, Python, AZ-104, IoT...)"
                    value={query} onChange={e => setQuery(e.target.value)}
                    style={{ width: '100%', padding: '0.62rem 1rem 0.62rem 2.2rem', fontFamily: 'var(--font-body)', fontSize: '0.85rem', border: '1px solid rgba(187,187,187,0.5)', background: 'var(--g-white)', color: 'var(--g-black)', outline: 'none' }}
                    onFocus={e => (e.target.style.borderColor = 'var(--g-red)')}
                    onBlur={e => (e.target.style.borderColor = 'rgba(187,187,187,0.5)')} />
                </div>
                {hasFilter && (
                  <button onClick={reset}
                    style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', fontFamily: 'var(--font-title)', fontSize: '0.66rem', fontWeight: 700, letterSpacing: '0.10em', textTransform: 'uppercase', color: '#888', background: 'transparent', border: '1px solid rgba(187,187,187,0.4)', padding: '0.55rem 1rem', cursor: 'pointer', whiteSpace: 'nowrap', transition: 'color 0.15s' }}
                    onMouseEnter={e => (e.currentTarget.style.color = 'var(--g-red)')}
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.65rem' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.65rem', flexWrap: 'wrap' }}>
                  <span style={{ fontFamily: 'var(--font-title)', fontSize: '0.58rem', fontWeight: 700, letterSpacing: '0.14em', textTransform: 'uppercase', color: '#aaa', flexShrink: 0, minWidth: '60px' }}>Modalité</span>
                  {['Toutes','Présentiel','FOAD','E-learning'].map(v => <Pill key={v} label={v} actif={fModalite === v} onClick={() => setFModalite(v)} />)}
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.65rem', flexWrap: 'wrap' }}>
                  <span style={{ fontFamily: 'var(--font-title)', fontSize: '0.58rem', fontWeight: 700, letterSpacing: '0.14em', textTransform: 'uppercase', color: '#aaa', flexShrink: 0, minWidth: '60px' }}>Territoire</span>
                  {[{v:'Tous',l:'Tous'},{v:'Martinique',l:'Martinique'},{v:'Guadeloupe',l:'Guadeloupe'},{v:'Paris',l:'Paris'},{v:'Tous territoires',l:'FOAD / Partout'}].map(x => <Pill key={x.v} label={x.l} actif={fTerritoire === x.v} onClick={() => setFTerritoire(x.v)} />)}
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.65rem', flexWrap: 'wrap' }}>
                  <span style={{ fontFamily: 'var(--font-title)', fontSize: '0.58rem', fontWeight: 700, letterSpacing: '0.14em', textTransform: 'uppercase', color: '#aaa', flexShrink: 0, minWidth: '60px' }}>Éditeur</span>
                  {[{v:'Tous',l:'Tous'},{v:'Cisco NetAcad',l:'Cisco NetAcad'},{v:'Microsoft',l:'Microsoft'}].map(x => <Pill key={x.v} label={x.l} actif={fEditeur === x.v} onClick={() => setFEditeur(x.v)} />)}
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.65rem', flexWrap: 'wrap' }}>
                  <span style={{ fontFamily: 'var(--font-title)', fontSize: '0.58rem', fontWeight: 700, letterSpacing: '0.14em', textTransform: 'uppercase', color: '#aaa', flexShrink: 0, minWidth: '60px' }}>Famille</span>
                  {familles.map(v => <Pill key={v} label={v === 'Toutes' ? 'Toutes' : v} actif={fFamille === v} onClick={() => setFFamille(v)} />)}
                </div>
                {/* Select formation */}
            ...
            {/* Résultats */}
            {results.length === 0 ? (
              <div style={{ padding: '4rem 2rem', textAlign: 'center', border: '1px solid rgba(187,187,187,0.3)', background: 'var(--g-offwhite)' }}>
                ...
                <p style={{ fontSize: '0.87rem', color: '#888', marginBottom: '1.5rem' }}>
                  Toutes nos formations sont disponibles sur mesure à la demande.
                </p>
                <div style={{ display: 'flex', justifyContent: 'center', gap: '1rem' }}>
                  ...
                  <a href="mailto:president@galactusdigital.com" className="btn-red" style={{ fontSize: '0.72rem' }}>
        ...
        {/* CTA contact — identique à l'original */}
        <section style={{ background: 'var(--g-offwhite)', padding: '3rem 2rem', borderTop: '3px solid var(--g-red)' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '2rem', flexWrap: 'wrap' }}>
            ...
            <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
              <a href="tel:+33781074746" className="btn-red" style={{ flexShrink: 0 }}><Phone size={16} /> Nous appeler</a>
              <a href="mailto:president@galactusdigital.com" className="btn-ghost-dark" style={{ flexShrink: 0 }}><Mail size={16} /> Nous écrire</a>
            </div>
          </div>
        </section>
