...
export const Route = createFileRoute('/formations/ccnp-cybersecurity-cbrcor')({
  component: CcnpCybersecurityCbrcorPage,
  head: () => ({
    meta: [
      { title: "CCNP Cybersecurity — CBRCOR 350-201 | GALACTUS Digital" },
      { name: "description", content: "CCNP Cybersecurity examen cœur CBRCOR 350-201 v1.2. 70h. Opérations de cybersécurité, playbooks, automatisation SOC. Ex-CyberOps Professional. Formateur CCNP certifié. Qualiopi." },
    ],
  }),
})
...
const DATA = {
  ...
  titre: 'CCNP Cybersecurity — Examen cœur (CBRCOR)',
  sousTitre: 'Performing Cybersecurity Using Cisco Security Technologies 350-201 v1.2 · Ex-CyberOps Professional',
  ref: 'CCNP-CYB-CBRCOR-001',
  niveau: 'Avancé',
  ...
  description: 'Examen cœur du CCNP Cybersecurity, le niveau professionnel des opérations de sécurité. Cisco a renommé CyberOps Professional en CCNP Cybersecurity le 3 février 2026, le jour où CyberOps Associate devenait CCNA Cybersecurity : même contenu, alignement sur la nomenclature CCNA/CCNP. La formation couvre les fondamentaux et les techniques de cybersécurité, les processus du centre opérationnel, et l\'automatisation appliquée à la détection et à la réponse. Elle s\'adresse à l\'analyste SOC qui veut passer du traitement d\'alertes à la conception des procédures.',
  objectifs: [
    'Interpréter et construire les composants d\'un playbook de sécurité',
    'Choisir les outils adaptés à un scénario de playbook donné',
    'Appliquer les techniques d\'analyse de menaces, de vulnérabilités et de risques',
    'Conduire les processus du SOC : triage, investigation, escalade et clôture',
    'Automatiser la détection et la réponse : API, scripts et orchestration',
    'Rédiger un rapport d\'incident exploitable par la direction et par les équipes techniques',
  ],
  public: [
    'Analystes SOC de niveau 1 visant le niveau 2 ou 3',
    'Titulaires du CCNA Cybersecurity en montée de compétence',
    'Ingénieurs sécurité et responsables de la réponse à incident',
    'Administrateurs réseau évoluant vers les opérations de sécurité',
    'Consultants en cybersécurité',
  ],
  prerequis: [
    'CCNA Cybersecurity (200-201) validé ou compétences équivalentes en surveillance de sécurité',
    'Expérience pratique du travail en centre opérationnel de sécurité recommandée',
    'Maîtrise des fondamentaux réseau : TCP/IP, routage, commutation',
    'Notions de scripting, Python de préférence',
    'Aucun prérequis formel n\'est exigé par Cisco pour se présenter à l\'examen',
  ],
  modules: [
    {
      num: '1.0', titre: 'Fondamentaux', duree: '14h',
      contenu: [
        'Composants d\'un playbook et logique de construction',
        'Détermination des outils adaptés à un scénario',
        'Modèles de menace, analyse de risque et référentiels de conformité',
        'TP — lecture et adaptation d\'un playbook existant',
      ],
    },
    {
      num: '2.0', titre: 'Techniques', duree: '18h',
      contenu: [
        'Renseignement sur les menaces et évaluation de vulnérabilités',
        'Analyse de malware et investigation multi-plateforme',
        'Corrélation d\'événements et réduction du bruit',
        'TP — investigation d\'une alerte de bout en bout',
      ],
    },
    {
      num: '3.0', titre: 'Processus', duree: '18h',
      contenu: [
        'Triage, escalade et cycle de vie d\'un incident',
        'Plan de réponse, continuité et reprise d\'activité',
        'Communication de crise et rapport d\'incident',
        'TP — conduite d\'un incident simulé en équipe',
      ],
    },
    {
      num: '4.0', titre: 'Automatisation', duree: '14h',
      contenu: [
        'API REST et intégration des outils de sécurité',
        'Scripts d\'enrichissement et d\'orchestration',
        'Automatisation de la réponse : cas d\'usage et limites',
        'TP — automatisation d\'une tâche de triage',
      ],
    },
    {
      ...
      contenu: [
        ...
        'Questions de type performance-based, QCM et glisser-déposer',
        'Examen blanc chronométré en conditions réelles',
      ],
    },
  ],
  examen: {
    code:       '350-201 CBRCOR v1.2',
    duree:      '120 minutes',
    langue:     'Anglais',
    organisme:  'Cisco, via Pearson VUE',
    format:     'Environ 90 à 110 questions — performance-based, QCM et glisser-déposer',
    score:      'Score de coupe variable, non publié par Cisco',
    note: 'La réussite du CBRCOR délivre le Cisco Certified Specialist – Cybersecurity Core et satisfait l\'exigence d\'examen cœur du CCNP Cybersecurity. La certification complète s\'obtient en y ajoutant une concentration : CBRFIR (forensique et réponse à incident) ou CBRTHD (chasse aux menaces). Certification valable 3 ans. Le voucher est compris dans le tarif e-learning.',
  },
  methodes: [
...
function CcnpCybersecurityCbrcorPage() {
  return (
    <>
      <Header />
      <main style={{ paddingTop: '72px' }}>
          ...
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
              {[
                ...
                { icon: <Calendar size={14} />, text: 'Voir calendrier', href: '/calendrier?f=ccnp-cybersecurity-cbrcor' },
              ].map((m, i) => (
                m.href ? (
        ...
        {/* ── Modalités & tarifs ── */}
        <TarifsModalites slug="ccnp-cybersecurity-cbrcor" />
