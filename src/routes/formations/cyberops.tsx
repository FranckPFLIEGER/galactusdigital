...
const DATA = {
  ...
  duree: '60 heures', groupeMin: 4, groupeMax: 12, lieux: ['Martinique', 'Guadeloupe', 'Paris', 'FOAD'],
  ...
  examen: { code: '200-201 CBROPS', duree: '120 minutes', langue: 'Anglais', organisme: 'Pearson VUE', format: 'QCM, simulation d\'analyse réseau', score: '750 / 1000', note: 'L\'examen 200-201 CBROPS est indépendant. Un seul examen suffit pour obtenir la certification CyberOps Associate, sans module préalable obligatoire.' },
  methodes: ['Formateur certifié Cisco — expert en cybersécurité opérationnelle', 'Plateforme Cisco NetAcad 24h/24 avec labs virtuels intégrés', 'Travaux pratiques sur Cisco Packet Tracer et outils réels (Wireshark, tcpdump)', 'Quiz de validation des acquis à chaque fin de module', 'Auto-évaluation en début et en fin de formation', 'Supports de cours officiels Cisco CyberOps inclus', 'Attestation de formation et de présence', 'Passage de l\'examen officiel Pearson VUE intégré'],
}
      ...
      <main style={{ paddingTop: '72px' }}>
        ...
        <section style={{ background: 'var(--g-black)', padding: '3rem 2rem', borderTop: '4px solid var(--g-red)' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '2rem', flexWrap: 'wrap' }}>
            <div><h2 className="section-h2-light" style={{ marginBottom: '0.4rem' }}>S'inscrire à cette formation</h2><p style={{ fontSize: '0.90rem', color: 'rgba(255,255,255,0.55)', margin: 0 }}>Devis sous 48h — sessions disponibles en Martinique, Guadeloupe, Paris et FOAD.</p></div>
