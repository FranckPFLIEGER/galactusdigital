        ...
        <section style={{ background: 'var(--g-white)', padding: '4rem 2rem' }}>
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            ...
            <p style={{ fontSize: '0.85rem', color: '#5a5a58', marginBottom: '2rem', fontStyle: 'italic', lineHeight: 1.6 }}>
              ...
              (Cisco CCNA/CCNP, Microsoft Azure/M365, CompTIA, IPv6 Forum, EC-Council, PMI) —
            ...
            <p style={{ fontSize: '0.75rem', color: '#888', marginTop: '0.75rem', fontStyle: 'italic', lineHeight: 1.6 }}>
              * Méthodologie : le taux de réussite est calculé sur la base des candidats ayant effectivement
              passé l'examen de certification éditeur. Les candidats formés n'ayant pas souhaité se présenter
              à l'examen ne sont pas comptabilisés. Source : attestations de réussite éditeurs
              (Cisco Networking Academy, Microsoft, CompTIA, IPv6 Forum, EC-Council, PMI).
            </p>
          </div>
        </section>
          ...
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2,1fr)', gap: '1.25rem' }}>
              {[
                ...
                { num: '06', title: 'Inscription dans l\'environnement professionnel', desc: 'Veille réglementaire (CARIF, Centre Inffo, AFDAS, AKTO, Service public). Veille métier (APEC, LinkedIn Cisco). Partenaire Cisco n° 3018982. Membre IPv6 Forum. Association ASPIK.' },
