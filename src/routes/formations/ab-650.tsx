...
export const Route = createFileRoute('/formations/ab-650')({
  component: FormationPage,
  head: () => ({
    meta: [
      { title: "AB-650 Microsoft 365 & AI Services (remplace MS-102) | GALACTUS Digital" },
      { name: "description", content: "Formation AB-650 Administering Microsoft 365 and AI Services. 35h. Remplace MS-102 retiré le 31/10/2026. Copilot, Entra ID, Purview. Qualiopi." },
    ],
  }),
})
...
const DATA = {
  ...
  titre: 'Microsoft 365 & AI Services Administrator',
  sousTitre: 'Certification Microsoft 365 AI Services Administrator Associate — AB-650 (remplace MS-102, retiré le 31/10/2026)',
  ref: 'AB-650-001',
  ...
  description: `Formation certifiante pour déployer et administrer un tenant Microsoft 365 : identité Entra ID, sécurité, conformité, services et déploiement. Niveau Expert.`,
  objectifs: ["Déployer et gérer un tenant M365", "Administrer identité et accès (Entra ID)", "Gérer sécurité et menaces (Defender)", "Assurer la conformité (Purview)", "Gérer Exchange, Teams, SharePoint", "Superviser les services"],
  public: ["Administrateurs Microsoft 365", "Ingénieurs systèmes et cloud", "Responsables IT M365", "Certifiés AB-900 (ou MS-900)"],
  prerequis: ["Expérience administration M365", "Connaissance Entra ID et DNS", "Notions sécurité et conformité", "Pratique d un tenant recommandée"],
  examen: { code: 'AB-650', duree: '120 minutes', langue: 'Français / Anglais', organisme: 'Microsoft (Pearson VUE)', format: 'QCM, études de cas et scénarios', score: '700 / 1000', note: `AB-650 remplace l'examen MS-102, retiré le 31 octobre 2026 : la certification Microsoft 365 Administrator Expert (2 examens) laisse place à AI Services Administrator Associate, obtenue avec ce seul examen, sans prérequis de certification. Valable 12 mois, renouvelable gratuitement via Microsoft Learn. L'examen certifiant est proposé en option.` },
...
function FormationPage() {
  const FORMATION = getFormationBySlug('ab-650')
          ...
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
              {[
                ...
                { icon: <Calendar size={14} />, text: 'Voir calendrier', href: '/calendrier?f=ab-650' },
              ].map((m, i) => (
                m.href ? (
