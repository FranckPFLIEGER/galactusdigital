...
export const Route = createFileRoute('/formations/ms-4017')({
  component: FormationPage,
  head: () => ({
    meta: [
      { title: "MS-4017 Étendre M365 Copilot — Applied Skills | GALACTUS Digital" },
      { name: "description", content: "Formation MS-4017 étendre Copilot. Applied Skills. Lab Microsoft Learn. Qualiopi." },
    ],
  }),
})
...
const DATA = {
  ...
  titre: 'Gérer et étendre Microsoft 365 Copilot',
  sousTitre: 'Applied Skills — Étendre M365 Copilot (MS-4017)',
  ref: 'MS-4017-001',
  niveau: 'Intermédiaire',
  partenaire: 'Partenaire Microsoft n° 4653557',
  certification: 'Microsoft Applied Skills: Manage and extend Microsoft 365 Copilot',
  duree: '7 heures',
  groupeMin: 3,
  groupeMax: 12,
  lieux: ['Martinique', 'Guadeloupe', 'Paris'],
  description: `Formation courte (Applied Skills) : gérer et étendre Microsoft 365 Copilot — agents déclaratifs, connecteurs Graph, extensibilité. Validation par évaluation en ligne (lab Microsoft Learn), sans examen Pearson VUE.`,
  objectifs: ["Configurer et gérer M365 Copilot", "Créer des agents déclaratifs", "Connecter des données via Graph", "Étendre Copilot avec des plugins", "Gérer sécurité et gouvernance", "Mesurer l adoption"],
  public: ["Administrateurs M365", "Développeurs low-code", "Référents Copilot", "Chefs de projet IA"],
  prerequis: ["Connaissance M365 et Copilot", "Notions Graph utiles", "Compréhension de la gouvernance", "Aucun développement avancé requis"],
  examen: { code: 'MS-4017', duree: 'Évaluation en lab', langue: 'Anglais', organisme: 'Microsoft Learn (Applied Skills — lab en ligne)', format: 'Évaluation pratique en environnement réel (pas d examen Pearson VUE)', score: 'Réussite / échec', note: `Applied Skills — Gérer et étendre Microsoft 365 Copilot. Évaluation Applied Skills réalisée en ligne sur Microsoft Learn (lab pratique), et non un examen Pearson VUE : aucun voucher requis.` },
...
function FormationPage() {
  const FORMATION = getFormationBySlug('ms-4017')
          ...
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
              {[
                ...
                { icon: <Calendar size={14} />, text: 'Voir calendrier', href: '/calendrier?f=ms-4017' },
              ].map((m, i) => (
                m.href ? (
