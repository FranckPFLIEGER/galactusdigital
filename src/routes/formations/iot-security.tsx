...
const DATA = {
  ...
  certification: 'Cisco IoT Fundamentals: IoT Security',
  duree: '60 heures',
  groupeMin: 4,
  groupeMax: 12,
  ...
  methodes: [
    ...
    "Certification Cisco IoT Fundamentals: IoT Security envoyée par mail à l'issue du parcours",
...
function FormationPage() {
  const FORMATION = getFormationBySlug('iot-security')
          ...
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
              {[
                ...
                { icon: <Calendar size={14} />, text: 'Voir calendrier', href: '/calendrier?f=iot-security' },
              ].map((m, i) => (
                m.href ? (
