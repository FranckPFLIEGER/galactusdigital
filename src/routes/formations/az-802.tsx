...
const DATA = {
  ...
  sousTitre: 'Certification Windows Server Hybrid — AZ-802',
  ref: 'AZ-802-001',
  ...
  examen: { code: 'AZ-802', duree: '120 minutes', langue: 'Français / Anglais', organisme: 'Microsoft (Pearson VUE)', format: 'QCM, études de cas et scénarios', score: '700 / 1000', note: `La certification Windows Server Hybrid Administrator s obtient avec AZ-800 et AZ-802. Le passage de l examen (voucher officiel) est inclus dans le tarif de la formation.` },
