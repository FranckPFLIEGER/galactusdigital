...
export const Route = createFileRoute('/formations/it-essentials')({
  component: ItEssentialsPage,
  head: () => ({
    meta: [
      { title: "IT Essentials — Préparation CompTIA A+ sans prérequis | GALACTUS Digital" },
      { name: "description", content: "Formation IT Essentials. 70h, aucun prérequis. Matériel, systèmes, dépannage. Préparation CompTIA A+ (220-1201 et 220-1202). 99 TP. Reconversion. Qualiopi." },
    ],
  }),
})
...
const DATA = {
  ...
  titre:          'IT Essentials',
  sousTitre:      'Préparation à la certification CompTIA A+ (Core 1 220-1201 · Core 2 220-1202)',
  ref:            'SOCLE-ITE-011',
  niveau:         'Fondamental',
  partenaire:     'Partenaire Cisco n° 3018982',
  certification:  'CompTIA A+ (Core 1 et Core 2)',
  ...
  // Description
  description: 'Le cursus historique d\'entrée dans le métier, et la certification la plus demandée par les employeurs sur un premier poste IT. Installer, configurer et dépanner ordinateurs, terminaux mobiles et logiciels, puis se connecter aux réseaux. 14 chapitres, 99 travaux pratiques, ordinateur portable virtuel et Cisco Packet Tracer. Aucun prérequis, et le socle attendu avant d\'aborder le CCNA.',

  // Objectifs pédagogiques
  objectifs: [
    'Assembler, configurer et mettre à niveau un poste de travail et ses périphériques',
    'Installer et dépanner les systèmes d\'exploitation Windows, Linux, macOS, Android et iOS',
    'Appliquer une méthodologie de dépannage structurée face à une panne matérielle ou logicielle',
    'Connecter un poste à un réseau filaire ou sans fil et diagnostiquer les pannes de connectivité',
    'Mettre en œuvre les mesures de sécurité attendues sur un poste utilisateur',
    'Appliquer les procédures opérationnelles et de sécurité d\'un service informatique',
  ],
  ...
  modules: [
    {
      num: '01–03', titre: 'Matériel et assemblage', duree: '16h',
      contenu: [
        'Composants, compatibilité et choix de configuration',
        'Assemblage complet d\'un poste et première mise en service',
        'Alimentation, refroidissement et sécurité des interventions',
        'TP — Montage, câblage et test de démarrage',
      ],
    },
    {
      num: '04–06', titre: 'Terminaux mobiles, impression et virtualisation', duree: '12h',
      contenu: [
        'Portables, tablettes et téléphones : matériel et interventions',
        'Imprimantes : installation, partage et dépannage',
        'Virtualisation et notions de cloud computing',
        'TP — Ordinateur portable virtuel NetAcad',
      ],
    },
    {
      num: '07–09', titre: 'Systèmes d\'exploitation', duree: '16h',
      contenu: [
        'Installation de Windows, Linux et macOS',
        'Systèmes mobiles Android et iOS',
        'Comptes, droits, stratégies et outils d\'administration',
        'TP — Installation et configuration multi-systèmes',
      ],
    },
    {
      num: '10–11', titre: 'Réseaux et connectivité', duree: '10h',
      contenu: [
        'Adressage IP, protocoles et services réseau',
        'Connexion filaire, Wi-Fi et configuration des équipements',
        'TP Cisco Packet Tracer — Connexion d\'un poste au réseau',
      ],
    },
    {
      num: '12–13', titre: 'Sécurité', duree: '10h',
      contenu: [
        'Menaces, vulnérabilités et vecteurs d\'attaque courants',
        'Durcissement d\'un poste et protection des données',
        'Élimination sécurisée des supports de stockage',
        'TP — Sécurisation complète d\'un poste utilisateur',
      ],
    },
    {
      num: '14', titre: 'Procédures opérationnelles et méthodologie', duree: '6h',
      contenu: [
        'Méthodologie de dépannage en 6 étapes',
        'Documentation, ticketing et communication professionnelle',
        'Révision par domaine d\'examen CompTIA A+',
        '2 examens de certification pratique + examen final du cours',
      ],
    },
  ],
  ...
  // Examen
  examen: {
    code:       '220-1201 (Core 1) et 220-1202 (Core 2)',
    duree:      '90 minutes par examen',
    langue:     'Anglais',
    organisme:  'CompTIA / Pearson VUE',
    format:     'Maximum 90 questions par examen : QCM, glisser-déposer et questions par simulation',
    score:      '675/900 pour le Core 1 · 700/900 pour le Core 2',
    note: 'La certification CompTIA A+ exige la réussite des deux examens, à passer dans un intervalle de trois ans. Série V15 en vigueur depuis mars 2025. Cours suivant recommandé : CCNAv2 — ITN (1/3). Prévoir l\'inscription aux examens auprès d\'un centre Pearson VUE.',
  },
...
function ItEssentialsPage() {
  const FORMATION = getFormationBySlug('it-essentials')
          ...
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
              {[
                ...
                { icon: <Calendar size={14} />, text: 'Voir calendrier', href: '/calendrier?f=it-essentials' },
              ].map((m, i) => (
                m.href ? (
