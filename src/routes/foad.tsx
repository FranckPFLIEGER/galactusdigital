...
const FORMATIONS = [
  { editeur: 'Cisco',      label: 'Partenaire n° 3018982', formations: [
    'CCNA — Introduction aux réseaux (ITN)',
    'CCNA — Commutation, Routage et Wi-Fi (SRWE)',
    'CCNA — Réseaux d'entreprise (ENSA)',
    'CyberOps Associate', 'Ethical Hacker',
    'Python Essentials 1 & 2', 'DevNet Associate',
    'IoT Fundamentals', 'Linux Essentials',
  ]},
  { editeur: 'Microsoft',  label: 'Partenaire n° 4653557', formations: [
    'AZ-900 Azure Fundamentals', 'AZ-104 Azure Administrator',
    'SC-900 Security, Compliance & Identity',
    'AI-900 Azure AI Fundamentals', 'MS-900 Microsoft 365 Fundamentals',
  ]},
  { editeur: 'IPv6 Forum', formations: [
