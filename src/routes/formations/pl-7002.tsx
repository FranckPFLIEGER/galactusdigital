...
export const Route = createFileRoute('/formations/pl-7002')({
  component: FormationPage,
  head: () => ({
    meta: [
      { title: "PL-7002 Power Automate — Applied Skills | GALACTUS Digital" },
      { name: "description", content: "Formation PL-7002 Power Automate. Applied Skills. Lab Microsoft Learn. Qualiopi." },
    ],
  }),
})
...
const DATA = {
  ...
  titre: 'Power Automate',
  sousTitre: 'Applied Skills — Automatiser des processus (PL-7002)',
  ref: 'PL-7002-001',
  niveau: 'Fondamental',
  partenaire: 'Partenaire Microsoft n° 4653557',
  certification: 'Microsoft Applied Skills: Create and manage automated processes by using Power Automate',
  duree: '7 heures',
  groupeMin: 3,
  groupeMax: 12,
  lieux: ['Martinique', 'Guadeloupe', 'Paris'],
  description: `Formation courte (Applied Skills) : créer et gérer des processus automatisés avec Power Automate — flux cloud, connecteurs, approbations. Validation par évaluation en ligne (lab Microsoft Learn), sans examen Pearson VUE.`,
  objectifs: ["Créer des flux cloud automatisés", "Utiliser les connecteurs M365 et tiers", "Mettre en place des approbations", "Gérer déclencheurs et conditions", "Traiter erreurs et monitoring", "Partager et gouverner les flux"],
  public: ["Utilisateurs métier et power users", "Analystes de processus", "Administrateurs M365", "Automatisation de tâches"],
  prerequis: ["Maîtrise de Microsoft 365", "Aucun développement requis", "Logique des processus métier", "À l aise avec la bureautique"],
  examen: { code: 'PL-7002', duree: 'Évaluation en lab', langue: 'Anglais', organisme: 'Microsoft Learn (Applied Skills — lab en ligne)', format: 'Évaluation pratique en environnement réel (pas d examen Pearson VUE)', score: 'Réussite / échec', note: `Applied Skills — Créer et gérer des processus automatisés avec Power Automate. Évaluation Applied Skills réalisée en ligne sur Microsoft Learn (lab pratique), et non un examen Pearson VUE : aucun voucher requis.` },
...
function FormationPage() {
  const FORMATION = getFormationBySlug('pl-7002')
          ...
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
              {[
                ...
                { icon: <Calendar size={14} />, text: 'Voir calendrier', href: '/calendrier?f=pl-7002' },
              ].map((m, i) => (
                m.href ? (
