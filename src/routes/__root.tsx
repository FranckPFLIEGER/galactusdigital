  ...
  head: () => ({
    meta: [
      ...
      { property: 'og:title',       content: 'GALACTUS Digital — Formation certifiante IT des territoires ultramarins' },
      {
        ...
        content: 'Organisme de formation certifié Qualiopi. Certifications Cisco Networking Academy, Microsoft et IPv6 Forum. 100% de réussite. 6 territoires ultramarins.',
      },
      { property: 'og:image',       content: 'https://www.galactusdigital.com/og-image.png' },
      { property: 'og:image:width',  content: '1200' },
      { property: 'og:image:height', content: '630' },
      { property: 'og:image:type',   content: 'image/png' },
      { property: 'og:image:alt',    content: 'GALACTUS Digital — Formation certifiante IT des territoires ultramarins. Partenaire Cisco, Microsoft et IPv6 Forum.' },
      ...
      { name: 'twitter:title',       content: 'GALACTUS Digital — Formation certifiante IT des territoires ultramarins' },
      {
        ...
        content: 'Formations IT officielles aux Caraïbes et Océan Indien. Certifié Qualiopi. Cisco Networking Academy, Microsoft, IPv6 Forum.',
      },
      { name: 'twitter:image',       content: 'https://www.galactusdigital.com/og-image-twitter.png' },
      { name: 'twitter:image:alt',   content: 'GALACTUS Digital — Formation certifiante IT des territoires ultramarins.' },
...
const jsonLd = {
  ...
  url: 'https://www.galactusdigital.com',
  logo: 'https://www.galactusdigital.com/galactus-icon.png',
