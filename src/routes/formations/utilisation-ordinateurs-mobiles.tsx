...
export const Route = createFileRoute('/formations/utilisation-ordinateurs-mobiles')({
  component: UtilisationOrdinateursMobilesPage,
  head: () => ({
    meta: [
      { title: "Utilisation d'ordinateurs et de mobiles — Formation sans prérequis | GALACTUS Digital" },
      { name: "description", content: "Formation Utilisation d'ordinateurs et d'équipements mobiles. 6h, aucun prérequis. Fichiers, logiciels, connectivité Wi-Fi et Bluetooth. Reconversion. Qualiopi." },
    ],
  }),
})
...
const DATA = {
  ...
  // Description
  description: 'Ce cours donne l\'aisance pratique attendue sur un poste de travail et sur un mobile : manipuler fichiers et dossiers, installer et gérer des logiciels, connecter un appareil en filaire, en Wi-Fi, en Bluetooth ou en cellulaire, et résoudre les incidents techniques les plus fréquents. Il aborde aussi les technologies IoT et l\'IA générative. Conçu pour les personnes qui utilisent un ordinateur sans en maîtriser le fonctionnement.',

  // Objectifs pédagogiques
  objectifs: [
    'Utiliser avec aisance le pavé tactile, la souris et les raccourcis clavier essentiels',
    'Gérer fichiers et dossiers sous Windows, Android et dans le Cloud',
    'Installer, mettre à jour et désinstaller logiciels et applications',
    'Gérer la connectivité d\'un appareil : filaire, LAN, Wi-Fi, Bluetooth et cellulaire',
    'Diagnostiquer et résoudre les problèmes techniques courants d\'un poste de travail',
    'Situer les technologies IoT et l\'IA générative dans un environnement professionnel',
  ],
  ...
  modules: [
    {
      num: '01', titre: 'Prise en main du poste de travail', duree: '1h30',
      contenu: [
        'Fonctionnalités d\'un ordinateur et d\'un terminal mobile',
        'Pavé tactile, souris, clavier et raccourcis essentiels',
        'Interface, fenêtres et paramètres de base',
      ],
    },
    {
      num: '02', titre: 'Fichiers, dossiers et Cloud', duree: '1h30',
      contenu: [
        'Arborescence de fichiers sous Windows et Android',
        'Créer, déplacer, renommer, rechercher et sauvegarder',
        'Stockage et synchronisation dans le Cloud',
      ],
    },
    {
      num: '03', titre: 'Logiciels et applications', duree: '1h30',
      contenu: [
        'Installation, mise à jour et désinstallation',
        'Accès aux services en ligne et gestion des comptes',
        'Explorer les technologies IoT et l\'IA générative',
      ],
    },
    {
      num: '04', titre: 'Connectivité et dépannage', duree: '1h30',
      contenu: [
        'Connexions filaires, LAN, Wi-Fi, Bluetooth et cellulaire',
        '7 scénarios de résolution de problèmes techniques courants',
        'Réduire l\'impact environnemental de son usage numérique',
  ...
  // Examen
  examen: {
    code:       'Badge NetAcad — Computers and Mobile Devices',
    duree:      'Examen final intégré au cours',
    langue:     'Français',
    organisme:  'Cisco Networking Academy',
    format:     'Quiz de module, exercices interactifs et examen final',
    score:      'Selon barème NetAcad',
    note: 'Cours suivant recommandé : Les bases du matériel informatique, puis Operating System Basics. Ce cours ouvre le Bloc 0 des parcours Support & Helpdesk et Modern Workplace Microsoft 365.',
  },
...
function UtilisationOrdinateursMobilesPage() {
  const FORMATION = getFormationBySlug('utilisation-ordinateurs-mobiles')
          ...
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
              {[
                ...
                { icon: <Calendar size={14} />, text: 'Voir calendrier', href: '/calendrier?f=utilisation-ordinateurs-mobiles' },
              ].map((m, i) => (
                m.href ? (
