...
export const Route = createFileRoute('/formations/operating-system-basics')({
  component: OperatingSystemBasicsPage,
  head: () => ({
    meta: [
      { title: "Operating System Basics — Formation sans prérequis | GALACTUS Digital" },
      { name: "description", content: "Formation Operating System Basics. 12h, aucun prérequis. Windows, Linux, Android, iOS. Outils d'administration, sécurité de base. Reconversion. Qualiopi." },
    ],
  }),
})
...
const DATA = {
  ...
  // Description
  description: 'Un système d\'exploitation, c\'est ce qui fait tourner tout le reste. Ce cours explique le rôle et les caractéristiques des principaux systèmes — Windows, Linux, Android et iOS — puis passe à la pratique : outils d\'administration Windows, premières mesures de sécurité sous Linux, configuration réseau et messagerie sur un mobile. 18 travaux pratiques. Aucun prérequis.',

  // Objectifs pédagogiques
  objectifs: [
    'Expliquer le rôle et les caractéristiques d\'un système d\'exploitation',
    'Utiliser les outils d\'administration de Windows (gestionnaire de tâches, services, observateur d\'événements)',
    'Mettre en œuvre les mesures de sécurité de base d\'un système Linux',
    'Gérer comptes utilisateurs, droits et permissions',
    'Configurer la connectivité réseau et la messagerie sur un terminal mobile',
    'Comparer les systèmes d\'exploitation mobiles Android et iOS',
  ],
  ...
  modules: [
    {
      num: '01–02', titre: 'Rôle et types de systèmes d\'exploitation', duree: '3h',
      contenu: [
        'Ce que fait un système d\'exploitation et pourquoi il est indispensable',
        'Panorama : Windows, macOS, Linux, Android, iOS',
        'Installation et démarrage d\'un système',
        'TP — Exploration d\'un système en machine virtuelle',
      ],
    },
    {
      num: '03–04', titre: 'Administration Windows', duree: '3h',
      contenu: [
        'Gestionnaire de tâches, services et observateur d\'événements',
        'Panneau de configuration et paramètres système',
        'Comptes utilisateurs, droits et permissions',
        'TP — Diagnostic d\'un poste Windows lent',
      ],
    },
    {
      num: '05–06', titre: 'Bases de la sécurité Linux', duree: '3h',
      contenu: [
        'Structure d\'un système Linux et arborescence des fichiers',
        'Utilisateurs, groupes et permissions',
        'Premières mesures de durcissement d\'un système',
        'TP — Configuration des droits sur des fichiers sensibles',
      ],
    },
    {
      num: '07–08', titre: 'Systèmes d\'exploitation mobiles', duree: '3h',
      contenu: [
        'Architecture d\'Android et d\'iOS, points communs et différences',
        'Configuration de la connectivité réseau sur un mobile',
        'Paramétrage de la messagerie et des comptes',
        'TP de synthèse + examen final du cours',
      ],
    },
  ],
  ...
  // Examen
  examen: {
    code:       'Badge NetAcad — Operating System Basics',
    duree:      'Examen final intégré au cours',
    langue:     'Anglais (accompagnement pédagogique en français)',
    organisme:  'Cisco Networking Academy',
    format:     '8 modules, 18 travaux pratiques, quiz et examen final',
    score:      'Selon barème NetAcad',
    note: 'Cours suivant recommandé : Notions de base sur les réseaux. Ce cours ouvre le Bloc 0 des parcours Réseaux, Cybersécurité, Cloud Azure, Modern Workplace et Sécurité Microsoft.',
  },
...
function OperatingSystemBasicsPage() {
  const FORMATION = getFormationBySlug('operating-system-basics')
          ...
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
              {[
                ...
                { icon: <Calendar size={14} />, text: 'Voir calendrier', href: '/calendrier?f=operating-system-basics' },
              ].map((m, i) => (
                m.href ? (
