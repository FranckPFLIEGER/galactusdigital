...
export const Route = createFileRoute('/formations/ccnp-security')({
  component: FormationPage,
  head: () => ({
    meta: [
      { title: "CCNP Security — SCOR 350-701 v2.0 | GALACTUS Digital" },
      { name: "description", content: "Formation CCNP Security (SCOR 350-701 v2.0). 80h. VPN ISE Secure Firewall, sécurité IA/LLM et post-quantique. Formateur CCNP/CCDP certifié. Qualiopi." },
    ],
  }),
})
...
const DATA = {
  editeur: 'Cisco',
  famille: 'Cisco — Sécurité (niveau professionnel)',
  titre: 'CCNP Security',
  sousTitre: 'SCOR 350-701 v2.0 · Formation dispensée par un formateur CCNP/CCDP certifié',
  ref: 'CCNP-SEC-001',
  niveau: 'Avancé',
  ...
  description: `Formation de niveau professionnel préparant à la certification CCNP Security, articulée autour de l'examen cœur SCOR (350-701 v2.0). Elle couvre la sécurité réseau et cloud, les VPN, la sécurité des accès (Cisco ISE), les pare-feu (Secure Firewall), la protection des endpoints, ainsi que les nouveaux enjeux 2026 : vulnérabilités IA/LLM et cryptographie post-quantique. Formation dispensée en propre par un formateur Cisco CCNP/CCDP certifié, préparant aux examens officiels Cisco. Prérequis recommandé : CCNA validé.`,
  objectifs: ["Sécuriser les infrastructures réseau et cloud — architecture Zero Trust", "Déployer les VPN — site-to-site, remote access, IPsec, TLS", "Mettre en œuvre le contrôle d'accès — Cisco ISE, 802.1X, TrustSec", "Configurer les pare-feu — Cisco Secure Firewall (FTD), politiques", "Protéger les endpoints et le contenu — Secure Endpoint, email, web", "Appréhender les menaces émergentes — sécurité IA/LLM, cryptographie post-quantique"],
  public: ["Administrateurs et ingénieurs sécurité certifiés CCNA", "Ingénieurs réseau évoluant vers la cybersécurité", "Analystes sécurité et administrateurs pare-feu", "Candidats à la certification CCNP Security"],
  prerequis: ["CCNA (200-301) validé ou compétences équivalentes", "Notions de sécurité réseau et de VPN", "Maîtrise de la configuration réseau Cisco", "3 à 5 ans d'expérience réseau/sécurité recommandés"],
  examen: {
  ...
  methodes: [
    ...
    "Labs pratiques sur Cisco Secure Firewall, ISE et solutions de sécurité réelles",
    "Supports officiels Cisco Press et blueprint SCOR 350-701 v2.0 à jour",
    "Ateliers pratiques — VPN, contrôle d'accès, réponse aux menaces",
    ...
    "Préparation intensive à l'examen officiel Cisco SCOR",
    "Attestation de formation, de présence et plan de travail individuel (Circ. DGEFP/MOC/2026/30 Art. 3)",
    "Passage de l'examen certifiant Cisco (Pearson VUE) accompagné",
  ],
}
...
function FormationPage() {
  const FORMATION = getFormationBySlug('ccnp-security')
          ...
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
              {[
                ...
                { icon: <Calendar size={14} />, text: 'Voir calendrier', href: '/calendrier?f=ccnp-security' },
              ].map((m, i) => (
                m.href ? (
                ...
                <div style={{ border: "1px solid rgba(187,187,187,0.3)", overflow: "hidden" }}>
                  <div style={{ background: "var(--g-red)", padding: "0.75rem 1.25rem", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    <div>
                      ...
                      <div style={{ fontFamily: "var(--font-title)", fontSize: "0.88rem", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.06em", color: "#fff" }}>Sécurité réseau & cloud</div>
                    </div>
                    <div style={{ display: "flex", alignItems: "center", gap: "0.3rem", fontSize: "0.78rem", color: "rgba(255,255,255,0.75)" }}><Clock size={13} />18h</div>
                  </div>
                  <div style={{ padding: "1rem 1.25rem", background: "var(--g-white)" }}>
                    <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "0.45rem" }}>
                      <li style={{ display: "flex", alignItems: "flex-start", gap: "0.5rem", fontSize: "0.83rem", color: "#5a5a58", lineHeight: 1.5 }}><div style={{ width: "5px", height: "5px", background: "var(--g-red)", flexShrink: 0, marginTop: "6px" }} />Concepts de sécurité — Zero Trust, modèles de menaces</li>
                      <li style={{ display: "flex", alignItems: "flex-start", gap: "0.5rem", fontSize: "0.83rem", color: "#5a5a58", lineHeight: 1.5 }}><div style={{ width: "5px", height: "5px", background: "var(--g-red)", flexShrink: 0, marginTop: "6px" }} />Sécurité réseau — segmentation, NGFW, IPS</li>
                      <li style={{ display: "flex", alignItems: "flex-start", gap: "0.5rem", fontSize: "0.83rem", color: "#5a5a58", lineHeight: 1.5 }}><div style={{ width: "5px", height: "5px", background: "var(--g-red)", flexShrink: 0, marginTop: "6px" }} />Sécurité du cloud — SaaS, IaaS, CASB</li>
                      <li style={{ display: "flex", alignItems: "flex-start", gap: "0.5rem", fontSize: "0.83rem", color: "#5a5a58", lineHeight: 1.5 }}><div style={{ width: "5px", height: "5px", background: "var(--g-red)", flexShrink: 0, marginTop: "6px" }} />Nouveautés 2026 — vulnérabilités IA/LLM</li>
                    </ul>
                  </div>
                </div>
                <div style={{ border: "1px solid rgba(187,187,187,0.3)", overflow: "hidden" }}>
                  <div style={{ background: "var(--g-red)", padding: "0.75rem 1.25rem", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    <div>
                      ...
                      <div style={{ fontFamily: "var(--font-title)", fontSize: "0.88rem", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.06em", color: "#fff" }}>VPN & cryptographie</div>
                    </div>
                    <div style={{ display: "flex", alignItems: "center", gap: "0.3rem", fontSize: "0.78rem", color: "rgba(255,255,255,0.75)" }}><Clock size={13} />16h</div>
                  </div>
                  <div style={{ padding: "1rem 1.25rem", background: "var(--g-white)" }}>
                    <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "0.45rem" }}>
                      <li style={{ display: "flex", alignItems: "flex-start", gap: "0.5rem", fontSize: "0.83rem", color: "#5a5a58", lineHeight: 1.5 }}><div style={{ width: "5px", height: "5px", background: "var(--g-red)", flexShrink: 0, marginTop: "6px" }} />VPN site-to-site et remote access</li>
                      <li style={{ display: "flex", alignItems: "flex-start", gap: "0.5rem", fontSize: "0.83rem", color: "#5a5a58", lineHeight: 1.5 }}><div style={{ width: "5px", height: "5px", background: "var(--g-red)", flexShrink: 0, marginTop: "6px" }} />IPsec, IKEv2, TLS/SSL</li>
                      <li style={{ display: "flex", alignItems: "flex-start", gap: "0.5rem", fontSize: "0.83rem", color: "#5a5a58", lineHeight: 1.5 }}><div style={{ width: "5px", height: "5px", background: "var(--g-red)", flexShrink: 0, marginTop: "6px" }} />PKI et gestion des certificats</li>
                      <li style={{ display: "flex", alignItems: "flex-start", gap: "0.5rem", fontSize: "0.83rem", color: "#5a5a58", lineHeight: 1.5 }}><div style={{ width: "5px", height: "5px", background: "var(--g-red)", flexShrink: 0, marginTop: "6px" }} />Cryptographie post-quantique (enjeux 2026)</li>
                    </ul>
                  </div>
                </div>
                <div style={{ border: "1px solid rgba(187,187,187,0.3)", overflow: "hidden" }}>
                  <div style={{ background: "var(--g-red)", padding: "0.75rem 1.25rem", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    <div>
                      ...
                      <div style={{ fontFamily: "var(--font-title)", fontSize: "0.88rem", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.06em", color: "#fff" }}>Contrôle d'accès & visibilité</div>
                    </div>
                    <div style={{ display: "flex", alignItems: "center", gap: "0.3rem", fontSize: "0.78rem", color: "rgba(255,255,255,0.75)" }}><Clock size={13} />24h</div>
                  </div>
                  <div style={{ padding: "1rem 1.25rem", background: "var(--g-white)" }}>
                    <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "0.45rem" }}>
                      <li style={{ display: "flex", alignItems: "flex-start", gap: "0.5rem", fontSize: "0.83rem", color: "#5a5a58", lineHeight: 1.5 }}><div style={{ width: "5px", height: "5px", background: "var(--g-red)", flexShrink: 0, marginTop: "6px" }} />Cisco ISE — profilage, posture, guest</li>
                      <li style={{ display: "flex", alignItems: "flex-start", gap: "0.5rem", fontSize: "0.83rem", color: "#5a5a58", lineHeight: 1.5 }}><div style={{ width: "5px", height: "5px", background: "var(--g-red)", flexShrink: 0, marginTop: "6px" }} />802.1X, TrustSec, segmentation par identité</li>
                      <li style={{ display: "flex", alignItems: "flex-start", gap: "0.5rem", fontSize: "0.83rem", color: "#5a5a58", lineHeight: 1.5 }}><div style={{ width: "5px", height: "5px", background: "var(--g-red)", flexShrink: 0, marginTop: "6px" }} />Sécurité de l'infrastructure — AAA, control plane</li>
                      <li style={{ display: "flex", alignItems: "flex-start", gap: "0.5rem", fontSize: "0.83rem", color: "#5a5a58", lineHeight: 1.5 }}><div style={{ width: "5px", height: "5px", background: "var(--g-red)", flexShrink: 0, marginTop: "6px" }} />Télémétrie, NetFlow et visibilité réseau</li>
                    </ul>
                  </div>
                </div>
                <div style={{ border: "1px solid rgba(187,187,187,0.3)", overflow: "hidden" }}>
                  <div style={{ background: "var(--g-red)", padding: "0.75rem 1.25rem", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    <div>
                      ...
                      <div style={{ fontFamily: "var(--font-title)", fontSize: "0.88rem", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.06em", color: "#fff" }}>Pare-feu & endpoints</div>
                    </div>
                    <div style={{ display: "flex", alignItems: "center", gap: "0.3rem", fontSize: "0.78rem", color: "rgba(255,255,255,0.75)" }}><Clock size={13} />22h</div>
                  </div>
                  <div style={{ padding: "1rem 1.25rem", background: "var(--g-white)" }}>
                    <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "0.45rem" }}>
                      <li style={{ display: "flex", alignItems: "flex-start", gap: "0.5rem", fontSize: "0.83rem", color: "#5a5a58", lineHeight: 1.5 }}><div style={{ width: "5px", height: "5px", background: "var(--g-red)", flexShrink: 0, marginTop: "6px" }} />Cisco Secure Firewall (FTD) — politiques, NAT</li>
                      <li style={{ display: "flex", alignItems: "flex-start", gap: "0.5rem", fontSize: "0.83rem", color: "#5a5a58", lineHeight: 1.5 }}><div style={{ width: "5px", height: "5px", background: "var(--g-red)", flexShrink: 0, marginTop: "6px" }} />Secure Endpoint — détection et réponse</li>
                      <li style={{ display: "flex", alignItems: "flex-start", gap: "0.5rem", fontSize: "0.83rem", color: "#5a5a58", lineHeight: 1.5 }}><div style={{ width: "5px", height: "5px", background: "var(--g-red)", flexShrink: 0, marginTop: "6px" }} />Sécurité email et web — filtrage, sandboxing</li>
                      <li style={{ display: "flex", alignItems: "flex-start", gap: "0.5rem", fontSize: "0.83rem", color: "#5a5a58", lineHeight: 1.5 }}><div style={{ width: "5px", height: "5px", background: "var(--g-red)", flexShrink: 0, marginTop: "6px" }} />Réponse aux incidents et automatisation SecOps</li>
                    </ul>
                  </div>
                </div>
            </div>
