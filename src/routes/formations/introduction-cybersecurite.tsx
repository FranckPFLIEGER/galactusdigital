...
export const Route = createFileRoute('/formations/introduction-cybersecurite')({
  component: IntroductionCybersecuritePage,
  head: () => ({
    meta: [
      { title: "Introduction à la cybersécurité — Formation sans prérequis | GALACTUS Digital" },
      { name: "description", content: "Formation Introduction à la cybersécurité. 6h, aucun prérequis. Cybermenaces, protection des données, métiers de la cyber. Brique CCST. Reconversion. Qualiopi." },
    ],
  }),
})
...
const DATA = {
  ...
  sousTitre:      'Bloc 0 des parcours métier · Brique du parcours CCST Cybersecurity',
  ref:            'SOCLE-ICS-006',
  niveau:         'Grand débutant',
  partenaire:     'Partenaire Cisco n° 3018982',
  certification:  'Badge numérique — brique du parcours CCST Cybersecurity',
  ...
  // Description
  description: 'Comprendre ce qu\'est vraiment une cyberattaque avant de vouloir la contrer. Ce cours explore les grandes tendances du cyberespace, les menaces qui pèsent sur les données personnelles et professionnelles, et les moyens concrets de s\'en protéger. Il ouvre aussi le panorama des métiers de la cybersécurité et de leurs débouchés. Aucun prérequis — c\'est le point d\'entrée du parcours Cybersécurité.',

  // Objectifs pédagogiques
  objectifs: [
    'Nommer les principales cybermenaces et décrire leurs mécanismes',
    'Expliquer pourquoi les données personnelles ont une valeur marchande',
    'Protéger ses données personnelles et sa vie privée en ligne et sur les réseaux sociaux',
    'Appliquer les bonnes pratiques de protection des données d\'une entreprise',
    'Identifier les enjeux de sécurité liés à un poste de travail connecté',
    'Situer les métiers de la cybersécurité, leurs missions et leurs débouchés',
  ],
  ...
  modules: [
    {
      num: '01', titre: 'Le besoin de cybersécurité', duree: '1h',
      contenu: [
        'Ce que valent vos données et pour qui',
        'Données personnelles et données d\'entreprise',
        'Panorama des incidents récents et de leur impact',
      ],
    },
    {
      num: '02', titre: 'Attaques, concepts et techniques', duree: '1h30',
      contenu: [
        'Logiciels malveillants et méthodes de propagation',
        'Ingénierie sociale et hameçonnage',
        'TP — Reconnaître une tentative d\'attaque',
      ],
    },
    {
      num: '03', titre: 'Protéger ses données et sa vie privée', duree: '1h30',
      contenu: [
        'Sécuriser ses appareils et ses comptes',
        'Chiffrement, sauvegarde et suppression sécurisée',
        'Confidentialité sur les réseaux sociaux',
        'TP — Audit de ses propres paramètres de confidentialité',
      ],
    },
    {
      num: '04', titre: 'Protéger l\'organisation', duree: '1h',
      contenu: [
        'Équipements et pratiques de défense en entreprise',
        'Comportement à adopter face à un incident',
        'Notions de politique de sécurité',
      ],
    },
    {
      num: '05', titre: 'Les métiers de la cybersécurité', duree: '1h',
      contenu: [
        'Analyste SOC, pentester, ingénieur sécurité : qui fait quoi',
        'Certifications et parcours de progression',
  ...
  // Examen
  examen: {
    code:       'Badge NetAcad — Introduction to Cybersecurity',
    duree:      'Examen final intégré au cours',
    langue:     'Français',
    organisme:  'Cisco Networking Academy',
    format:     '5 modules, 7 exercices pratiques, quiz et examen final',
    score:      'Selon barème NetAcad',
    note: 'Ce cours fait partie du parcours Cybersecurity Career Path et s\'aligne sur la certification CCST Cybersecurity. Cours suivant recommandé : Networking Essentials ou Cybersecurity Essentials.',
  },
...
function IntroductionCybersecuritePage() {
  const FORMATION = getFormationBySlug('introduction-cybersecurite')
          ...
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
              {[
                ...
                { icon: <Calendar size={14} />, text: 'Voir calendrier', href: '/calendrier?f=introduction-cybersecurite' },
              ].map((m, i) => (
                m.href ? (
