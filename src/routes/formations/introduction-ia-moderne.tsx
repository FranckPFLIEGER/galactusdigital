...
export const Route = createFileRoute('/formations/introduction-ia-moderne')({
  component: IntroductionIaModernePage,
  head: () => ({
    meta: [
      { title: "Introduction à l'IA moderne — Formation sans prérequis | GALACTUS Digital" },
      { name: "description", content: "Formation Introduction à l'IA moderne. 6h, aucun prérequis. Chatbots, vision par ordinateur, rédaction de prompts. Reconversion. Territoires ultramarins. Qualiopi." },
    ],
  }),
})
...
const DATA = {
  ...
  // Description
  description: 'L\'IA est arrivée dans tous les métiers, y compris au helpdesk et dans l\'exploitation réseau. Ce cours interactif en donne les bases à partir d\'applications gratuites : comment fonctionne un chatbot, ce qu\'est la vision par ordinateur, comment rédiger un prompt qui donne un résultat exploitable, et où sont les limites. 50 vidéos et 16 exercices de sollicitation. Aucun prérequis.',

  // Objectifs pédagogiques
  objectifs: [
    'Expliquer en termes simples comment fonctionne un modèle d\'IA générative',
    'Rédiger des prompts précis et obtenir des résultats exploitables',
    'Identifier les limites et les erreurs typiques d\'un chatbot',
    'Décrire les principes de la vision par ordinateur et de la traduction automatique',
    'Appliquer l\'IA à des tâches concrètes de productivité personnelle et professionnelle',
    'Repérer les questions de confidentialité posées par l\'usage d\'outils d\'IA publics',
  ],
  ...
  modules: [
    {
      num: '01', titre: 'Comprendre l\'IA générative', duree: '3h',
      contenu: [
        'Ce qu\'est un modèle d\'IA et comment il produit une réponse',
        'Vision par ordinateur et traduction automatique en pratique',
        'Ce qu\'une IA sait faire et ce qu\'elle ne sait pas faire',
        'Contenu vidéo de cours et démonstrations',
      ],
    },
    {
      num: '02', titre: 'Rédiger des prompts et appliquer l\'IA', duree: '3h',
      contenu: [
        'Anatomie d\'un prompt efficace : contexte, tâche, format attendu',
        '16 exercices de sollicitation de chatbot',
        'Usages professionnels : rédaction, synthèse, aide au dépannage',
        'Confidentialité : ce qu\'on ne partage jamais avec un chatbot public',
        'Projet vidéo pratique et examen final du cours',
      ],
    },
  ],
  ...
  // Examen
  examen: {
    code:       'Badge NetAcad — Introduction to Modern AI',
    duree:      'Examen final intégré au cours',
    langue:     'Français',
    organisme:  'Cisco Networking Academy',
    format:     '2 modules, 50 vidéos, 16 exercices de prompt, projet vidéo et examen final',
    score:      'Selon barème NetAcad',
    note: 'Cours suivant recommandé : AI-901 Azure AI Fundamentals pour la voie Microsoft, ou Introduction à la science des données pour la voie Data. Ce cours ouvre le Bloc 0 des parcours Automatisation & IA réseau et Data, IA & Copilot.',
  },
...
function IntroductionIaModernePage() {
  const FORMATION = getFormationBySlug('introduction-ia-moderne')
          ...
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
              {[
                ...
                { icon: <Calendar size={14} />, text: 'Voir calendrier', href: '/calendrier?f=introduction-ia-moderne' },
              ].map((m, i) => (
                m.href ? (
