...
export const Route = createFileRoute('/formations/iot-introduction')({
  ...
  head: () => ({
    meta: [
      { title: "IoT Introduction Cisco Networking Academy — Objets connectés | GALACTUS Digital" },
...
const DATA = {
  ...
  certification: 'Cisco IoT Introduction',
  duree: '20 heures',
  groupeMin: 4,
  groupeMax: 12,
  ...
  methodes: [
    ...
    "Certification Cisco IoT Introduction envoyée par mail à l'issue du parcours",
...
function FormationPage() {
  const FORMATION = getFormationBySlug('iot-introduction')
          ...
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
              {[
                ...
                { icon: <Calendar size={14} />, text: 'Voir calendrier', href: '/calendrier?f=iot-introduction' },
              ].map((m, i) => (
                m.href ? (
