...
export const Route = createFileRoute('/formations/data-analytics-essentials')({
  ...
  head: () => ({
    meta: [
      { title: "Data Analytics Essentials Cisco Networking Academy | GALACTUS Digital" },
...
const DATA = {
  ...
  famille: 'Cisco Networking Academy — Data & Analytics',
...
function FormationPage() {
  const FORMATION = getFormationBySlug('data-analytics-essentials')
          ...
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
              {[
                ...
                { icon: <Calendar size={14} />, text: 'Voir calendrier', href: '/calendrier?f=data-analytics-essentials' },
              ].map((m, i) => (
                m.href ? (
