...
const DATA = {
  ...
  description: `Premier cours de la série CCNP Enterprise (version 9), ENCOR constitue l'examen cœur. Il couvre l'architecture réseau d'entreprise, la double pile IPv4/IPv6, la virtualisation, l'infrastructure (commutation, routage, sans-fil), l'assurance réseau, la sécurité et l'automatisation. Il prépare à l'examen Cisco 350-401 (blueprint v1.2) et constitue le socle du CCNP Enterprise ainsi que du CCIE Enterprise. Formation dispensée par un formateur Cisco CCNP/CCDP certifié. Prérequis recommandé : CCNA validé.`,
  objectifs: [
  ...
  modules: [
    ...
    { num: '02', titre: 'Virtualisation & infrastructure', duree: '18h', contenu: [
      ...
      "Sans-fil d'entreprise — WLC, roaming, RF",
    ] as Item[] },
